...
function change_values() {
    ...
    sudo sed -i "s/upload_max_filesize = .*/upload_max_filesize = $size/" /etc/php/8.2/fpm/php.ini
    sudo sed -i "s/upload_max_filesize = .*/upload_max_filesize = $size/" /etc/php/8.2/cli/php.ini
    sudo sed -i "s/post_max_size = .*/post_max_size = $size/" /etc/php/8.2/fpm/php.ini
    sudo sed -i "s/post_max_size = .*/post_max_size = $size/" /etc/php/8.2/cli/php.ini
